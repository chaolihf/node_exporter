...
func chooseProtocol(ctx context.Context, IPProtocol string, fallbackIPProtocol bool, target string, metrics []prometheus.Metric, logger log.Logger) (ip *net.IPAddr, lookupTime float64, err error) {
