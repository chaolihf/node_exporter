...
func matchRegularExpressions(reader io.Reader, httpConfig HTTPProbe, logger log.Logger) bool {
...
func matchRegularExpressionsOnHeaders(header http.Header, httpConfig HTTPProbe, logger log.Logger) bool {
...
func ProbeHTTP(ctx context.Context, target string, module Module, registry *prometheus.Registry, logger log.Logger) (success bool) {
	var redirects int
	var (
