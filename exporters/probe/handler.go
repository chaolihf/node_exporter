...
func LoadConfigFromFile(confFile string, logger log.Logger) (*Config, error) {
	var c = &Config{}
...
func RequestHandler(w http.ResponseWriter, r *http.Request, c *Config, logger log.Logger, rh *ResultHistory, timeoutOffset float64, params url.Values,
	...
	probeSuccessGauge := prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "black_probe_success",
		Help: "Displays whether or not the probe was a success",
	})
	probeDurationGauge := prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "black_probe_duration_seconds",
...
func setHTTPHost(hostname string, module *Module) error {
...
func DebugOutput(module *Module, logBuffer *bytes.Buffer, registry *prometheus.Registry) string {
	buf := &bytes.Buffer{}
...
func getTimeout(r *http.Request, module Module, offset float64) (timeoutSeconds float64, err error) {
